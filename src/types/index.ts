...
export interface SystemConfig { id?: string; globalServiceFee: number; maturationHours: number; minRedeemAmount: number; platformStatus: 'active' | 'maintenance'; supportEmail: string; vantagensUrl: string; merchantTerms?: string; clientFaqs?: string; merchantFaqs?: string; showMemberCount?: boolean; 
  // Visibility flags controllable by admin
  showClientWallet?: boolean;
  showClientRatings?: boolean;
  showClientAntiWaste?: boolean;
  showClientEvents?: boolean;
  showMerchantTerminal?: boolean;
  showMerchantMarketing?: boolean;
  showMerchantAntiWaste?: boolean;
  showMerchantSettings?: boolean;
  updatedAt?: any; appVersion?: string; lastChangeBy?: string; }
