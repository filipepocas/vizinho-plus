...
import { ShieldCheck, Mail, Lock, Save, AlertCircle, CheckCircle2, Clock, Percent, Activity, Wallet, ExternalLink, Star, Database } from 'lucide-react';
...
const AdminSettings: React.FC = () => {
  ...
  const handleUpdateSystem = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Configurações aplicadas com sucesso a toda a plataforma!' });
    } catch (e) {
  ...
  return (
    <div className="font-sans text-[#0a2540] animate-in fade-in duration-500">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-8">
          <div>
            ...
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-3 flex items-center gap-2">
              <Database size={12} /> Ajustes Globais da Plataforma
            </p>
          </div>
        ...
        {message.text && (
          <div className={`mb-8 p-6 rounded-3xl border-4 font-black text-[11px] uppercase flex items-center gap-4 animate-in zoom-in-95 ${
              ...
              <div className="space-y-4 bg-blue-50 p-8 rounded-[40px] border-4 border-blue-100">
                ...
                <div className="bg-white p-6 rounded-3xl border-2 border-blue-200">
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase mt-2 leading-relaxed italic">
                    * O cashback acumulado num mês só fica disponível no dia 1 do mês seguinte, após o processamento manual no Painel Principal.
                  </p>
                </div>
              </div>
